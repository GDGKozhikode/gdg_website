...
This is the frontend part of the GDG kozhikode wesite build with Google's [Material Design Lite](https://getmdl.io/)(MDL) & [Web Starter Kit](https://github.com/google/web-starter-kit).
